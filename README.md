...
│ System Prompt (人设+规则)    │
├─────────────────────────────┤
│ 💬 工作记忆 — 最近 20 条对话  │  实时追加，自动滚动
├─────────────────────────────┤
│ 📌 核心事实 — top 18 条       │  双向记忆（用户 + 她自己的事）
│    "喜欢FPS游戏" "我答应帮他复习" │  每 ~25 条 LLM 提取，importance 排序
├─────────────────────────────┤
│ 📝 对话摘要 — 最近 3 批       │  每 ~30 条压缩，老摘要二次压缩
├─────────────────────────────┤
│ 🌡️ 情感轨迹 — 最近 7 天       │  氛围标签：warm/intimate/vulnerable...
├─────────────────────────────┤
│ 💎 核心记忆 — 1 条（触发式）   │  🆕 永久保存的重要原话
│    "6月10日深夜，他说..."      │  关键词/情绪/深夜/倾诉触发
├─────────────────────────────┤
│ 🎯 共同瞬间 — 1 条（20%概率） │  里程碑 + LLM 提取的温暖时刻
├─────────────────────────────┤
│ 🏷️ 里程碑 — 100/300/500/1000 条时触发一次 │  自然回顾"我们已经聊了XX条了呢"
└─────────────────────────────┘
```
